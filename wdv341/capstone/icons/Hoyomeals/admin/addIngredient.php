    ...
    <script>
        ...
        function addIngredient() {
            ...
            selectElement.addEventListener('change', () => {
                displayIngredient("ingredient" + idCount, "ingredientImg_" + idCount);
            });
        ...
        <main onclick="hideSideNav()">
            ...
            <div class="main-content-div">
                ...
                ?>
                    ...
                    <form class="submit_recipe_form_styles" action="">
                            ...
                            <div id="ingredient_container">
                                ...
                                <div class="form_row">
                                    ...
                                    <div class="ingrediantSelectColumn">
                                        <select name="ingredient[]" id="ingredientSelect_1" onchange="displayIngredient('ingredient1', 'ingredientImg_1')" required>
                            ...
                            <div id="recipeStep_container">
                                <div class="form_row" style="padding-bottom: 0px;">
                                    <div class="one_column">
                                        ...
                                        <input type="text" name="recipeSteps[]" placeholder="Cut the Carrots" required>
                                    </div>
                                </div>
                                <div class="form_row">
                                    <div class="one_column">
                                        <label for="recipeDescription"></label>
                                        <textarea name="recipeDescriptions[]" placeholder="Wash and cut the carrots into small, bite-sized pieces." required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form_row" style="padding-top: 30px;">
